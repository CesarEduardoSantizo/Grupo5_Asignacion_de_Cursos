namespace loginadmi.Administrador.Cursos
{
    partial class frmListadoCursos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnl_home.Controls.Add(this.btnMostrarCursos);
            this.pnl_home.Controls.Add(this.txtCarrera);
            this.pnl_home.Controls.Add(this.lblCarrera);
            this.pnl_home.Controls.Add(this.txtAño);
            this.pnl_home.Controls.Add(this.lblAño);
            this.pnl_home.Controls.Add(this.txtSemestre);
            this.pnl_home.Controls.Add(this.lblSemestre);
            this.pnl_home.Controls.Add(this.lblInstruccion);
            this.pnl_home.Controls.Add(this.dgvListadoAsignaciones);
            this.pnl_home.Controls.Add(this.lblTituloHabilitacion);
            this.pnl_home.Controls.Add(this.panEncabezado);
            this.pnl_home.Location = new System.Drawing.Point(243, -3);
